...
$(document).ready(function () {
    $("#version").html("Memory - Ordinals v" + VERSION + " &copy 2014 C00lSch00l");
...
function setUp() {
    call = ['FIRST', 'SECOND', 'THIRD', 'FOURTH', 'FIFTH', 'SIXTH', 'SEVENTH', 'EIGHTH', 'NINTH', 'TENTH', 'ELEVENTH', 'TWELFTH'];
    response = ['1<span class="red">st</span>','2<span class="green">nd</span>','3<span class="blue">rd</span>','4<span class="orange">th</span>','5<span class="orange">th</span>','6<span class="orange">th</span>','7<span class="orange">th</span>','8<span class="orange">th</span>','9<span class="orange">th</span>','10<span class="orange">th</span>','11<span class="orange">th</span>','12<span class="orange">th</span>'];
    combinedArray = [];
